                            ...
                            <div class="form-group">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="info">
                                        <textarea name="info" placeholder="Thông tin khác ....." class="form-control" id="editor" rows="10"></textarea>
                                    </div>
                                    <div class="tab-pane fade" id="info_en">
                                        <textarea name="info_en" placeholder="Thông tin khác ....." class="form-control" id="editor_en" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
